...
export default function ProductFormInventory({
  ...
  const formattedProductNameOptions = productNameOptions.map((item) => ({
    ...
    >
      ...
      <div className="space-y-4">
        {products.map((product, index) => {
          ...
          // استخدم totalValue إذا موجود، وإلا احسبها من الكمية والسعر
          const total =
            product.totalValue !== undefined && product.totalValue !== null
